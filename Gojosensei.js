...
module.exports = GojoMdNx = async (GojoMdNx, m, chatUpdate, store) => {
	...
	//group target \\
const reply = (teks) => {
            GojoMdNx.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botname}`,"body": ` 乂𝐂𝐨𝐤𝐁𝐨𝐭乂`, "previewType": "PHOTO", ${global.thumb}}}, { quoted: m})
        }
	...
	if (db.data.settings[botNumber].autobio) {
	  ...
	  //antilink\\
        ...
        reply(`「 ANTI LINK 」\n\nKamu Terdeteksi Mengirim Group Link, Maaf kamu akan segera Dikick!`)
        if (!isBotAdmins) return reply(`Saya Bukan ADMIN, Tidak Bisa Mengkick Orang yang Mengirim Link 😒`)
        let gclink = (`https://chat.whatsapp.com/`+await GojoMdNx.groupInviteCode(m.chat))
        let isLinkThisGc = new RegExp(gclink, 'i')
        let isgclink = isLinkThisGc.test(m.text)
        if (isgclink) return reply(`Group Terinstall Dengan Anti-Link Tapi Aku Tidak Akan Mengkickmu 😉, Karena Kamu Yang Mengirim Group Link Ini❤️`)
        if (isAdmins) return reply(`Group Terinstall Dengan Anti-Link Tapi Aku Tidak Akan Menendang BOKONGMU 😉, Karena Kamu Admin❤️`)
        if (isCreator) return reply(`Group Terinstall Dengan Anti-Link Tapi Aku Tidak Bisa Melakukan Ini😉, Because You Are My Owner Hahahahah🤣😘, Aku Menghormatimu Sebagai Penciptaku 😘😘😘`)
...
${Array.from(room.jawaban, (jawaban, index) => {
    ...
    ${isSurender ? '' : `Perfect Player`}`.trim()
        ...
        if (kuismath.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await reply(`🎮 Math Quiz 🎮\n\nJawaban Benar 🎉\n\nIngin Bermain Lagi? Send ${prefix}math mode`)
...
Click https://wa.me/${botNumber.split`@`[0]}`, m, { mentions: [roof.p, roof.p2] })
	    ...
	    if (!roof.pilih && !roof.pilih2) GojoMdNx.sendText(m.chat, `Kedua Pemain Tidak Ingin Bermain,\nSuit Dibatalkan`)
	    else if (!roof.pilih || !roof.pilih2) {
	    win = !roof.pilih ? roof.p2 : roof.p
	    GojoMdNx.sendTextWithMentions(m.chat, `@${(roof.pilih ? roof.p2 : roof.p).split`@`[0]} Tidak Memilih Suit, Game Over!`, m)
	    }
	    delete this.suit[roof.id]
	    return !0
	    }, roof.timeout)
	    ...
	    roof.text = m.text
	    reply(`You Have Chosen ${m.text} ${!roof.pilih2 ? `\n\nMenunggu Lawan Yang Cupu Untuk Memilih` : ''}`)
	    if (!roof.pilih2) GojoMdNx.sendText(roof.p2, '_Musuh Cupu Telah Memilih_\nSekarang Giliranmu Tod', 0)
	    }
	    if (jwb2 && reg.test(m.text) && !roof.pilih2 && !m.isGroup) {
	    roof.pilih2 = reg.exec(m.text.toLowerCase())[0]
	    roof.text2 = m.text
	    reply(`You Have Chosen ${m.text} ${!roof.pilih ? `\n\nMenunggu Lawan Yang Cupu Untuk Memilih` : ''}`)
	    if (!roof.pilih) GojoMdNx.sendText(roof.p, '_Musuh Cupu Telah Memilih_\nSekarang Giliranmu Tod', 0)
	    }
...
Please @${m.mentionedJid[0].split`@`[0]} To Type Accept/Reject`
	    ...
	    case 'family100': {
            ...
            case 'guess': {
                ...
                if (args[0] === "song") {
                    ...
                    GojoMdNx.sendButtonText(m.chat, [{ buttonId: 'guess song', buttonText: { displayText: 'Guess The Song' }, type: 1 }], `Waktu Telah Habis\nAnswer:  ${tebaklagu[m.sender.split('@')[0]]}\n\nMain Lagi? Tekan Tombol Dibawah`, GojoMdNx.user.name, m)
                    delete tebaklagu[m.sender.split('@')[0]]
                    }
                    ...
                    console.log("Answer: " + result.jawaban)
                    GojoMdNx.sendButtonText(m.chat, [{ buttonId: 'guess picture', buttonText: { displayText: 'Guess The Picture' }, type: 1 }], `Waktu Telah Habis\nAnswer:  ${tebakgambar[m.sender.split('@')[0]]}\n\nMain Lagi? Tekan Tombol Dibawah`, GojoMdNx.user.name, m)
                    delete tebakgambar[m.sender.split('@')[0]]
                    }
                } else if (args[0] === 'word') {
                    ...
                    console.log("Answer: " + result.jawaban)
                    GojoMdNx.sendButtonText(m.chat, [{ buttonId: 'guess word', buttonText: { displayText: 'Guess The Word' }, type: 1 }], `Waktu Telah Habis\nAnswer:  ${tebakkata[m.sender.split('@')[0]]}\n\nMain Lagi? Tekan Tombol Dibawah`, GojoMdNx.user.name, m)
                    delete tebakkata[m.sender.split('@')[0]]
                    }
                } else if (args[0] === 'sentence') {
                    if (tebakkalimat.hasOwnProperty(m.sender.split('@')[0])) return replay(`Masih Ada Sessi Yang Belum Habis!`)
                    ...
                    console.log("Answer: " + result.jawaban)
                    GojoMdNx.sendButtonText(m.chat, [{ buttonId: 'guess sentence', buttonText: { displayText: 'Guess The Sentence' }, type: 1 }], `Waktu Telah Habis\nAnswer:  ${tebakkalimat[m.sender.split('@')[0]]}\n\nMain Lagi? Tekan Tombol Dibawah`, GojoMdNx.user.name, m)
                    delete tebakkalimat[m.sender.split('@')[0]]
                    }
                } else if (args[0] === 'lyrics') {
                    if (tebaklirik.hasOwnProperty(m.sender.split('@')[0])) return replay(`Masih Ada Sessi Yang Belum Habis!`)
                    ...
                    console.log("Answer: " + result.jawaban)
                    GojoMdNx.sendButtonText(m.chat, [{ buttonId: 'guess lyrics', buttonText: { displayText: 'Guess The Lyrics' }, type: 1 }], `Waktu Telah Habis\nAnswer:  ${tebaklirik[m.sender.split('@')[0]]}\n\Main Lagi? Tekan Tombol Dibawah`, GojoMdNx.user.name, m)
                    delete tebaklirik[m.sender.split('@')[0]]
                    }
                } else if (args[0] === 'blank') {
                    if (caklontong.hasOwnProperty(m.sender.split('@')[0])) return replay(`Masih Ada Sessi Yang Belum Habis!`)
		    ...
		    caklontong_desk[m.sender.split('@')[0]] = result.deskripsi
                    ...
                    console.log("Answer: " + result.jawaban)
                    GojoMdNx.sendButtonText(m.chat, [{ buttonId: 'guess blank', buttonText: { displayText: 'Guess The Blank' }, type: 1 }], `Waktu Telah Habis\nAnswer:  ${caklontong[m.sender.split('@')[0]]}\nDescription : ${caklontong_desk[m.sender.split('@')[0]]}\n\Main Lagi? Tekan Tombol Dibawah`, GojoMdNx.user.name, m)
                    delete caklontong[m.sender.split('@')[0]]
		    delete caklontong_desk[m.sender.split('@')[0]]
                    }
                }
	...
	case 'react': {
            ...
            case 'kuismath': case 'math': {
                if (kuismath.hasOwnProperty(m.sender.split('@')[0])) return replay(`Masih Ada Sessi Yang Belum Habis!`)
             ...
             break
                case 'listgc': case 'gclist': {
                 ...
                 for (let i of anu) {
                     ...
                     teks += `乂 *Name :* ${metadata.subject}\n乂 *Owner :* @${metadata.owner.split('@')[0]}\n乂 *ID :* ${metadata.id}\n乂 *Made :* ${moment(metadata.creation * 1000).tz('Asia/Kolkata').format('DD/MM/YYYY HH:mm:ss')}\n💫 *Member :* ${metadata.participants.length}\n\n────────────────────────\n\n`
                 }
                 GojoMdNx.sendTextWithMentions(m.chat, teks, m)
             }
             break
...
break
        ...
        case 'google': {
                ...
                for (let g of res) {
                teks += `乂 *Title* : ${g.title}\n`
                teks += `乂 *Description* : ${g.snippet}\n`
                teks += `乂 *Link* : ${g.link}\n\n────────────────────────\n\n`
                } 
                reply(teks)
                })
...
乂 Url : ${anu.url}`,
		...
		let { pinterest } = require('./lib/scraper')
                ...
                GojoMdNx.sendMessage(m.chat, { image: { url: result }, caption: '乂 Media Url : '+result }, { quoted: m })
            }
            break
...
break
	    ...
	    case 'nomerhoki': case 'nomorhoki': {
            ...
            case 'artimimpi': case 'tafsirmimpi': {
                ...
                if (anu.status == false) return reply(anu.message)
                GojoMdNx.sendText(m.chat, `乂 *Dream :* ${anu.message.mimpi}\n乂 *Meaning :* ${anu.message.arti}\n乂 *Solution :* ${anu.message.solusi}`, m)
            }
            break
            ...
            case 'suamiistri': {
                ...
                if (anu.status == false) return reply(anu.message)
                GojoMdNx.sendText(m.chat, `乂 *Husband's Name :* ${anu.message.suami.nama}\n乂 *Husband Born :* ${anu.message.suami.tgl_lahir}\n乂 *Wife's Name :* ${anu.message.istri.nama}\n乂 *Born Wife :* ${anu.message.istri.tgl_lahir}\n乂 *Results :* ${anu.message.result}\n乂 *Notes :* ${anu.message.catatan}`, m)
            }
            break
            ...
            case 'artinama': {
                ...
                if (anu.status == false) return reply(anu.message)
                GojoMdNx.sendText(m.chat, `乂 *Name :* ${anu.message.nama}\n乂 *Meaning :* ${anu.message.arti}\n乂 *Notes :* ${anu.message.catatan}`, m)
            }
            break
            case 'kecocokannama': case 'cocoknama': {
                ...
                if (anu.status == false) return reply(anu.message)
                GojoMdNx.sendText(m.chat, `乂 *Name :* ${anu.message.nama}\n乂 *Born :* ${anu.message.tgl_lahir}\n乂 *Life Path :* ${anu.message.life_path}\n乂 *Destiny :* ${anu.message.destiny}\n乂 *Destiny Desire :* ${anu.message.destiny_desire}\n乂 *Personality :* ${anu.message.personality}\n乂 *Percentage :* ${anu.message.persentase_kecocokan}`, m)
            }
            break
            case 'kecocokanpasangan': case 'cocokpasangan': case 'pasangan': {
                ...
                if (anu.status == false) return reply(anu.message)
                GojoMdNx.sendImage(m.chat,  anu.message.gambar, `乂 *Your Name :* ${anu.message.nama_anda}\n乂 *Couple Name :* ${anu.message.nama_pasangan}\n乂 *Positive Side :* ${anu.message.sisi_positif}\n乂 *Negative Side :* ${anu.message.sisi_negatif}`, m)
            }
            break
            case 'jadianpernikahan': case 'jadiannikah': {
                ...
                if (anu.status == false) return reply(anu.message)
                GojoMdNx.sendText(m.chat, `乂 *Wedding Date :* ${anu.message.tanggal}\n乂 *Characteristics :* ${anu.message.karakteristik}`, m)
            }
            break
            case 'sifatusaha': {
                ...
                if (anu.status == false) return reply(anu.message)
                GojoMdNx.sendText(m.chat, `乂 *Born :* ${anu.message.hari_lahir}\n乂 *Business :* ${anu.message.usaha}`, m)
            }
            break
            case 'rejeki': case 'rezeki': {
                ...
                if (anu.status == false) return reply(anu.message)
                GojoMdNx.sendText(m.chat, `乂 *Born :* ${anu.message.hari_lahir}\n乂 *Sustenance :* ${anu.message.rejeki}\n乂 *Notes :* ${anu.message.catatan}`, m)
            }
            break
            case 'pekerjaan': case 'kerja': {
                ...
                if (anu.status == false) return reply(anu.message)
                GojoMdNx.sendText(m.chat, `乂 *Born :* ${anu.message.hari_lahir}\n乂 *Profession :* ${anu.message.pekerjaan}\n乂 *Notes :* ${anu.message.catatan}`, m)
            }
            break
            case 'ramalannasib': case 'ramalnasib': case 'nasib': {
                ...
                if (anu.status == false) return reply(anu.message)
                GojoMdNx.sendText(m.chat, `乂 *Analysis :* ${anu.message.analisa}\n乂 *Root Number :* ${anu.message.angka_akar}\n乂 *Nature :* ${anu.message.sifat}\n乂 *Element :* ${anu.message.elemen}\n乂 *Lucky Numbers :* ${anu.message.angka_keberuntungan}`, m)
            }
            break
            ...
            case 'artitarot': case 'tarot': {
                ...
                if (anu.status == false) return reply(anu.message)
                GojoMdNx.sendImage(m.chat, anu.message.image, `乂 *Born :* ${anu.message.tgl_lahir}\n乂 *Tarot Symbol :* ${anu.message.simbol_tarot}\n乂 *Meaning :* ${anu.message.arti}\n乂 *Notes :* ${anu.message.catatan}`, m)
            }
            break
            case 'fengshui': {
                ...
                if (anu.status == false) return reply(anu.message)
                GojoMdNx.sendText(m.chat, `乂 *Name :* ${anu.message.nama}\n乂 *Born :* ${anu.message.tahun_lahir}\n乂 *Gender :* ${anu.message.jenis_kelamin}\n乂 *Kua Number :* ${anu.message.angka_kua}\n乂 *Group :* ${anu.message.kelompok}\n乂 *Character :* ${anu.message.karakter}\n乂 *Good Sector :* ${anu.message.sektor_baik}\n乂 *Bad Sector :* ${anu.message.sektor_buruk}`, m)
            }
            break
            case 'haribaik': {
                if (!text) throw `Example : ${prefix + command} 7, 7, 2005`
                ...
                if (anu.status == false) return reply(anu.message)
                GojoMdNx.sendText(m.chat, `乂 *Born :* ${anu.message.tgl_lahir}\n乂 *When Challenged :* ${anu.message.kala_tinantang}\n乂 *Info :* ${anu.message.info}\n乂 *Notes :* ${anu.message.catatan}`, m)
            }
            break
            ...
            case 'harinaas': case 'harisial': {
                ...
                if (anu.status == false) return reply(anu.message)
                GojoMdNx.sendText(m.chat, `乂 *Day Of Birth :* ${anu.message.hari_lahir}\n乂 *Date Of Birth :* ${anu.message.tgl_lahir}\n🐦 *Fateful Day :* ${anu.message.hari_naas}\n🐦 *Info :* ${anu.message.catatan}\n🐦 *Notes :* ${anu.message.info}`, m)
            }
            break
            ...
            case 'memancing': {
                ...
                if (anu.status == false) return reply(anu.message)
                GojoMdNx.sendText(m.chat, `乂 *Date :* ${anu.message.tgl_memancing}\n乂 *Results :* ${anu.message.result}\n🐦 *Notes :* ${anu.message.catatan}`, m)
            }
            break
            case 'masasubur': {
                ...
                if (anu.status == false) return reply(anu.message)
                GojoMdNx.sendText(m.chat, `乂 *Results :* ${anu.message.result}\n乂 *Notes :* ${anu.message.catatan}`, m)
            }
            break
            case 'zodiak': case 'zodiac': {
                ...
                if (anu.status == false) return reply(anu.message)
                GojoMdNx.sendText(m.chat, `乂 *Zodiac :* ${anu.message.zodiak}\n乂 *Number :* ${anu.message.nomor_keberuntungan}\n乂 *Aroma :* ${anu.message.aroma_keberuntungan}\n乂 *Planet :* ${anu.message.planet_yang_mengitari}\n乂 *Flower :* ${anu.message.bunga_keberuntungan}\n乂 *Color :* ${anu.message.warna_keberuntungan}\n乂 *Stone :* ${anu.message.batu_keberuntungan}\n乂 *Element :* ${anu.message.elemen_keberuntungan}\n乂 *Zodiac Couple :* ${anu.message.pasangan_zodiak}\n乂 *Notes :* ${anu.message.catatan}`, m)
            }
            break
            case 'shio': {
                ...
                if (anu.status == false) return reply(anu.message)
                GojoMdNx.sendText(m.chat, `乂 *Results :* ${anu.message}`, m)
            }
            break
		...
		if (!isPremium && global.db.data.users[m.sender].limit < 1) return reply('Your Daily Limit Has Expired')
		    ...
		    db.data.users[m.sender].limit -= 1
                    ...
                    if (anu.status == false) return reply(anu.result.message)
                    GojoMdNx.sendMedia(m.chat, anu.caption.profile_hd, '', `乂 Full Name : ${anu.caption.full_name}\n乂 User Name : ${anu.caption.user_name}\n乂 ID ${anu.caption.user_id}\n乂 Following : ${anu.caption.followers}\n乂 Followers : ${anu.caption.following}\n乂 Bussines : ${anu.caption.bussines}\n乂 Professional : ${anu.caption.profesional}\n乂 Verified : ${anu.caption.verified}\n乂 Private : ${anu.caption.private}\n乂 Bio : ${anu.caption.biography}\n乂 Bio Url : ${anu.caption.bio_url}`, m)
		    db.data.users[m.sender].limit -= 1
                } else if (type.toLowerCase() == 'npm') {
                    if (!id) return reply(`No Query username, Example : ${prefix + command} npm scrape-primbon`)
                    let { result: anu } = await fetchJson(api('zenz', '/api/stalker/npm', { query: id }, 'apikey'))
                    if (anu.status == false) return reply(anu.result.message)
                    reply(`乂 Name : ${anu.name}\n乂 Version : ${Object.keys(anu.versions)}\n乂 Created : ${tanggal(anu.time.created)}\n乂 Modified : ${tanggal(anu.time.modified)}\n乂 Maintainers :\n ${anu.maintainers.map(v => `- ${v.name} : ${v.email}`).join('\n')}\n\n乂 Description : ${anu.description}\n乂 Homepage : ${anu.homepage}\n乂 Keywords : ${anu.keywords}\n乂 Author : ${anu.author.name}\n乂 License : ${anu.license}\n乂 Readme : ${anu.readme}`)
		    db.data.users[m.sender].limit -= 1
                } else {
		...
		case 'igeh': case 'instagram2x': case 'ig2': case 'igdl2': {
            ...
            case 'joox': case 'jooxdl': {
                ...
                let msg = await GojoMdNx.sendImage(m.chat, anu.result.img, `乂 Title : ${anu.result.lagu}\n乂 Album : ${anu.result.album}\n乂 Singer : ${anu.result.penyanyi}\n乂 Publish : ${anu.result.publish}\n乂 Lyrics :\n${anu.result.lirik.result}`, m)
            ...
            case 'soundcloud': case 'scdl': {
                ...
                let msg = await GojoMdNx.sendImage(m.chat, anu.result.thumb, `乂 Title : ${anu.result.title}\n乂 Url : ${isUrl(text)[0]}`)
	        ...
	        case 'fbdlx': case 'fbx': case 'facebookx': {
                ...
                GojoMdNx.sendMessage(m.chat, { video: { url: anu.result.url }, caption: `乂 Title : ${anu.result.title}`}, { quoted: m })
            }
            break
...
`,
		    ...
		    anu.media.map(async (url) => {
		        GojoMdNx.sendMessage(m.chat, { image: { url }, caption: `乂 Title : ${anu.title}\n乂 Author : ${anu.author.name}\n乂 Like : ${anu.like}\n乂 Caption : ${anu.caption}` }, { quoted: m })
		    })
		}
	    }
	    break
